...
3.Create an SGDClassifier with specified parameters.
Train the classifier using the training data (fit() method).
...
## Output:
<img width="874" height="412" alt="image" src="https://github.com/user-attachments/assets/c3b068c0-9087-4658-836e-5d69edaf183a" />
